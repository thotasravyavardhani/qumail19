...
if __name__ == '__main__':
    ...
    # CRITICAL FIX: The app must be explicitly run synchronously here to block 
    # the terminal and keep the server running stably on port 8080.
    kme_simulator.app.run(
        host=kme_simulator.host, 
        port=kme_simulator.port, 
        debug=False,  # Essential for stable terminal execution
        use_reloader=False
    )
