...
def load_config() -> Dict[str, Any]:
    ...
    config = {
        ...
        'gmail_client_id': os.getenv('QUMAIL_GMAIL_CLIENT_ID', 'mock_gmail_client_id'),
        'gmail_client_secret': os.getenv('QUMAIL_GMAIL_CLIENT_SECRET', 'mock_gmail_client_secret'),
        'yahoo_client_id': os.getenv('QUMAIL_YAHOO_CLIENT_ID', 'mock_yahoo_client_id'),
        'yahoo_client_secret': os.getenv('QUMAIL_YAHOO_CLIENT_SECRET', 'mock_yahoo_client_secret'),
        'outlook_client_id': os.getenv('QUMAIL_OUTLOOK_CLIENT_ID', 'mock_outlook_client_id'),
        'outlook_client_secret': os.getenv('QUMAIL_OUTLOOK_CLIENT_SECRET', 'mock_outlook_client_secret'),
